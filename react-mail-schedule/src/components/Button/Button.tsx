...
export function Button({ type = 'button', variant, children }: Props) {
  ...
  if (variant === 'dark')
    bgColor =
      'bg-primaryDark text-white hover:bg-primary hover:text-white active:bg-primaryLight active:text-gray-700';
  if (variant === 'light')
    bgColor =
      'bg-primaryLight text-gray-700 hover:bg-primary hover:text-white active:bg-primaryDark active:text-white';
  return (
    <button
